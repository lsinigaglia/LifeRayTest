...
/**
 * Provides the local service utility for PianiDiQualita. This utility wraps
 * <code>servicebuilder.service.impl.PianiDiQualitaLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PianiDiQualitaLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>servicebuilder.service.impl.PianiDiQualitaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PianiDiQualita addPianiDiQualita(
		PianiDiQualita pianiDiQualita) {

		return getService().addPianiDiQualita(pianiDiQualita);
	}
	 ...
	 */
	public static PianiDiQualita createPianiDiQualita(long Id_PianiDiQualita) {
		return getService().createPianiDiQualita(Id_PianiDiQualita);
	}
	 ...
	 */
	public static PianiDiQualita deletePianiDiQualita(long Id_PianiDiQualita)
		throws PortalException {

		return getService().deletePianiDiQualita(Id_PianiDiQualita);
	}
	 ...
	 * @return the piani di qualita that was removed
	 */
	public static PianiDiQualita deletePianiDiQualita(
		PianiDiQualita pianiDiQualita) {

		return getService().deletePianiDiQualita(pianiDiQualita);
	}
	...
	public static PianiDiQualita fetchPianiDiQualita(long Id_PianiDiQualita) {
		return getService().fetchPianiDiQualita(Id_PianiDiQualita);
	}
	 ...
	 * @throws PortalException if a piani di qualita with the primary key could not be found
	 */
	public static PianiDiQualita getPianiDiQualita(long Id_PianiDiQualita)
		throws PortalException {

		return getService().getPianiDiQualita(Id_PianiDiQualita);
	}
	 ...
	 */
	public static List<PianiDiQualita> getPianiDiQualitas(int start, int end) {
		return getService().getPianiDiQualitas(start, end);
	}
	 ...
	 */
	public static int getPianiDiQualitasCount() {
		return getService().getPianiDiQualitasCount();
	}
	 ...
	 */
	public static PianiDiQualita updatePianiDiQualita(
		PianiDiQualita pianiDiQualita) {

		return getService().updatePianiDiQualita(pianiDiQualita);
	}

	public static PianiDiQualitaLocalService getService() {
		return _service;
	}

	private static volatile PianiDiQualitaLocalService _service;
