...
/**
 * Provides the local service utility for Documenti. This utility wraps
 * <code>servicebuilder.service.impl.DocumentiLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DocumentiLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>servicebuilder.service.impl.DocumentiLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Documenti addDocumenti(Documenti documenti) {
		return getService().addDocumenti(documenti);
	}
	 ...
	 */
	public static Documenti createDocumenti(String CodiceDocumento) {
		return getService().createDocumenti(CodiceDocumento);
	}
	 ...
	 */
	public static Documenti deleteDocumenti(Documenti documenti) {
		return getService().deleteDocumenti(documenti);
	}
	 ...
	 */
	public static Documenti deleteDocumenti(String CodiceDocumento)
		throws PortalException {

		return getService().deleteDocumenti(CodiceDocumento);
	}
	...
	public static Documenti fetchDocumenti(String CodiceDocumento) {
		return getService().fetchDocumenti(CodiceDocumento);
	}
	 ...
	 * @throws PortalException if a documenti with the primary key could not be found
	 */
	public static Documenti getDocumenti(String CodiceDocumento)
		throws PortalException {

		return getService().getDocumenti(CodiceDocumento);
	}
	 ...
	 */
	public static List<Documenti> getDocumentis(int start, int end) {
		return getService().getDocumentis(start, end);
	}
	 ...
	 */
	public static int getDocumentisCount() {
		return getService().getDocumentisCount();
	}
	 ...
	 */
	public static Documenti updateDocumenti(Documenti documenti) {
		return getService().updateDocumenti(documenti);
	}

	public static DocumentiLocalService getService() {
		return _service;
	}

	private static volatile DocumentiLocalService _service;
