...
/**
 * Provides the local service utility for PianiDiLavoroObiettivo. This utility wraps
 * <code>servicebuilder.service.impl.PianiDiLavoroObiettivoLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PianiDiLavoroObiettivoLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>servicebuilder.service.impl.PianiDiLavoroObiettivoLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PianiDiLavoroObiettivo addPianiDiLavoroObiettivo(
		PianiDiLavoroObiettivo pianiDiLavoroObiettivo) {

		return getService().addPianiDiLavoroObiettivo(pianiDiLavoroObiettivo);
	}
	 ...
	 */
	public static PianiDiLavoroObiettivo createPianiDiLavoroObiettivo(
		long Id_PianoDiLavoro) {

		return getService().createPianiDiLavoroObiettivo(Id_PianoDiLavoro);
	}
	 ...
	 */
	public static PianiDiLavoroObiettivo deletePianiDiLavoroObiettivo(
			long Id_PianoDiLavoro)
		throws PortalException {

		return getService().deletePianiDiLavoroObiettivo(Id_PianoDiLavoro);
	}
	...
	public static PianiDiLavoroObiettivo deletePianiDiLavoroObiettivo(
		...
		return getService().deletePianiDiLavoroObiettivo(
	...
	public static PianiDiLavoroObiettivo fetchPianiDiLavoroObiettivo(
		long Id_PianoDiLavoro) {

		return getService().fetchPianiDiLavoroObiettivo(Id_PianoDiLavoro);
	}
	 ...
	 * @throws PortalException if a piani di lavoro obiettivo with the primary key could not be found
	 */
	public static PianiDiLavoroObiettivo getPianiDiLavoroObiettivo(
			long Id_PianoDiLavoro)
		throws PortalException {

		return getService().getPianiDiLavoroObiettivo(Id_PianoDiLavoro);
	}
	 ...
	 */
	public static List<PianiDiLavoroObiettivo> getPianiDiLavoroObiettivos(
		int start, int end) {

		return getService().getPianiDiLavoroObiettivos(start, end);
	}
	 ...
	 */
	public static int getPianiDiLavoroObiettivosCount() {
		return getService().getPianiDiLavoroObiettivosCount();
	}
	 ...
	 */
	public static PianiDiLavoroObiettivo updatePianiDiLavoroObiettivo(
		PianiDiLavoroObiettivo pianiDiLavoroObiettivo) {

		return getService().updatePianiDiLavoroObiettivo(
			pianiDiLavoroObiettivo);
	}

	public static PianiDiLavoroObiettivoLocalService getService() {
		return _service;
	}

	private static volatile PianiDiLavoroObiettivoLocalService _service;
