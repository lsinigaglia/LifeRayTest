...
/**
 * Provides the local service utility for StatoAvanzamentoLavori. This utility wraps
 * <code>servicebuilder.service.impl.StatoAvanzamentoLavoriLocalServiceImpl</code> and
 ...
 * @generated
 */
public class StatoAvanzamentoLavoriLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>servicebuilder.service.impl.StatoAvanzamentoLavoriLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static StatoAvanzamentoLavori addStatoAvanzamentoLavori(
		StatoAvanzamentoLavori statoAvanzamentoLavori) {

		return getService().addStatoAvanzamentoLavori(statoAvanzamentoLavori);
	}
	 ...
	 */
	public static StatoAvanzamentoLavori createStatoAvanzamentoLavori(
		long Id_SAL) {

		return getService().createStatoAvanzamentoLavori(Id_SAL);
	}
	 ...
	 */
	public static StatoAvanzamentoLavori deleteStatoAvanzamentoLavori(
			long Id_SAL)
		throws PortalException {

		return getService().deleteStatoAvanzamentoLavori(Id_SAL);
	}
	...
	public static StatoAvanzamentoLavori deleteStatoAvanzamentoLavori(
		...
		return getService().deleteStatoAvanzamentoLavori(
	...
	public static StatoAvanzamentoLavori fetchStatoAvanzamentoLavori(
		long Id_SAL) {

		return getService().fetchStatoAvanzamentoLavori(Id_SAL);
	}
	 ...
	 * @throws PortalException if a stato avanzamento lavori with the primary key could not be found
	 */
	public static StatoAvanzamentoLavori getStatoAvanzamentoLavori(long Id_SAL)
		throws PortalException {

		return getService().getStatoAvanzamentoLavori(Id_SAL);
	}
	 ...
	 */
	public static List<StatoAvanzamentoLavori> getStatoAvanzamentoLavoris(
		int start, int end) {

		return getService().getStatoAvanzamentoLavoris(start, end);
	}
	 ...
	 */
	public static int getStatoAvanzamentoLavorisCount() {
		return getService().getStatoAvanzamentoLavorisCount();
	}
	 ...
	 */
	public static StatoAvanzamentoLavori updateStatoAvanzamentoLavori(
		StatoAvanzamentoLavori statoAvanzamentoLavori) {

		return getService().updateStatoAvanzamentoLavori(
			statoAvanzamentoLavori);
	}

	public static StatoAvanzamentoLavoriLocalService getService() {
		return _service;
	}

	private static volatile StatoAvanzamentoLavoriLocalService _service;
