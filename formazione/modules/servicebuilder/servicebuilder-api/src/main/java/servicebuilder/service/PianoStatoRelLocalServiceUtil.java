...
/**
 * Provides the local service utility for PianoStatoRel. This utility wraps
 * <code>servicebuilder.service.impl.PianoStatoRelLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PianoStatoRelLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>servicebuilder.service.impl.PianoStatoRelLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PianoStatoRel addPianoStatoRel(PianoStatoRel pianoStatoRel) {
		return getService().addPianoStatoRel(pianoStatoRel);
	}
	 ...
	 */
	public static PianoStatoRel createPianoStatoRel(long Id_Relazione) {
		return getService().createPianoStatoRel(Id_Relazione);
	}
	 ...
	 */
	public static PianoStatoRel deletePianoStatoRel(long Id_Relazione)
		throws PortalException {

		return getService().deletePianoStatoRel(Id_Relazione);
	}
	 ...
	 * @return the piano stato rel that was removed
	 */
	public static PianoStatoRel deletePianoStatoRel(
		PianoStatoRel pianoStatoRel) {

		return getService().deletePianoStatoRel(pianoStatoRel);
	}
	...
	public static PianoStatoRel fetchPianoStatoRel(long Id_Relazione) {
		return getService().fetchPianoStatoRel(Id_Relazione);
	}
	 ...
	 * @throws PortalException if a piano stato rel with the primary key could not be found
	 */
	public static PianoStatoRel getPianoStatoRel(long Id_Relazione)
		throws PortalException {

		return getService().getPianoStatoRel(Id_Relazione);
	}
	 ...
	 */
	public static List<PianoStatoRel> getPianoStatoRels(int start, int end) {
		return getService().getPianoStatoRels(start, end);
	}
	 ...
	 */
	public static int getPianoStatoRelsCount() {
		return getService().getPianoStatoRelsCount();
	}
	 ...
	 */
	public static PianoStatoRel updatePianoStatoRel(
		PianoStatoRel pianoStatoRel) {

		return getService().updatePianoStatoRel(pianoStatoRel);
	}

	public static PianoStatoRelLocalService getService() {
		return _service;
	}

	private static volatile PianoStatoRelLocalService _service;
