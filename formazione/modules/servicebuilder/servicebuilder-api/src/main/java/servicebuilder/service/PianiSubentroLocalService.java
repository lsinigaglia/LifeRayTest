...
/**
 * Provides the local service interface for PianiSubentro. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PianiSubentroLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PianiSubentroLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>servicebuilder.service.impl.PianiSubentroLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the piani subentro local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PianiSubentroLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PianiSubentro addPianiSubentro(PianiSubentro pianiSubentro);
	...
	public PianiSubentro createPianiSubentro(long Id_PianiSubentro);
	...
	public PianiSubentro deletePianiSubentro(long Id_PianiSubentro)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public PianiSubentro deletePianiSubentro(PianiSubentro pianiSubentro);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PianiSubentro fetchPianiSubentro(long Id_PianiSubentro);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PianiSubentro getPianiSubentro(long Id_PianiSubentro)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<PianiSubentro> getPianiSubentros(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public PianiSubentro updatePianiSubentro(PianiSubentro pianiSubentro);
