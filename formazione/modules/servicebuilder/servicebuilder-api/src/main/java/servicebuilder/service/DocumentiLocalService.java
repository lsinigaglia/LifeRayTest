...
/**
 * Provides the local service interface for Documenti. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DocumentiLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DocumentiLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>servicebuilder.service.impl.DocumentiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the documenti local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DocumentiLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Documenti addDocumenti(Documenti documenti);
	...
	public Documenti createDocumenti(String CodiceDocumento);
	...
	public Documenti deleteDocumenti(Documenti documenti);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Documenti deleteDocumenti(String CodiceDocumento)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Documenti fetchDocumenti(String CodiceDocumento);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Documenti getDocumenti(String CodiceDocumento)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Documenti> getDocumentis(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Documenti updateDocumenti(Documenti documenti);
