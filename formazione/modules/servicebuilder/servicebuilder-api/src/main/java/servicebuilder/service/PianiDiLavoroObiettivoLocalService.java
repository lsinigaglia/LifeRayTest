...
/**
 * Provides the local service interface for PianiDiLavoroObiettivo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PianiDiLavoroObiettivoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PianiDiLavoroObiettivoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>servicebuilder.service.impl.PianiDiLavoroObiettivoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the piani di lavoro obiettivo local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PianiDiLavoroObiettivoLocalServiceUtil} if injection and service tracking are not available.
	 */
