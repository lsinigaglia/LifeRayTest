...
/**
 * Provides the local service utility for PianiFabbisogni. This utility wraps
 * <code>servicebuilder.service.impl.PianiFabbisogniLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PianiFabbisogniLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>servicebuilder.service.impl.PianiFabbisogniLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PianiFabbisogni addPianiFabbisogni(
		PianiFabbisogni pianiFabbisogni) {

		return getService().addPianiFabbisogni(pianiFabbisogni);
	}
	 ...
	 */
	public static PianiFabbisogni createPianiFabbisogni(
		long Id_PianiFabbisogni) {

		return getService().createPianiFabbisogni(Id_PianiFabbisogni);
	}
	 ...
	 */
	public static PianiFabbisogni deletePianiFabbisogni(long Id_PianiFabbisogni)
		throws PortalException {

		return getService().deletePianiFabbisogni(Id_PianiFabbisogni);
	}
	 ...
	 * @return the piani fabbisogni that was removed
	 */
	public static PianiFabbisogni deletePianiFabbisogni(
		PianiFabbisogni pianiFabbisogni) {

		return getService().deletePianiFabbisogni(pianiFabbisogni);
	}

	public static PianiFabbisogni deletePianiFabbisogniWithChildren(long id)
		throws PortalException {

		return getService().deletePianiFabbisogniWithChildren(id);
	}
	...
	public static PianiFabbisogni fetchPianiFabbisogni(
		long Id_PianiFabbisogni) {

		return getService().fetchPianiFabbisogni(Id_PianiFabbisogni);
	}
	 ...
	 * @throws PortalException if a piani fabbisogni with the primary key could not be found
	 */
	public static PianiFabbisogni getPianiFabbisogni(long Id_PianiFabbisogni)
		throws PortalException {

		return getService().getPianiFabbisogni(Id_PianiFabbisogni);
	}
	 ...
	 */
	public static List<PianiFabbisogni> getPianiFabbisognis(
		int start, int end) {

		return getService().getPianiFabbisognis(start, end);
	}
	 ...
	 */
	public static int getPianiFabbisognisCount() {
		return getService().getPianiFabbisognisCount();
	}
	 ...
	 */
	public static PianiFabbisogni updatePianiFabbisogni(
		PianiFabbisogni pianiFabbisogni) {

		return getService().updatePianiFabbisogni(pianiFabbisogni);
	}

	public static PianiFabbisogniLocalService getService() {
		return _service;
	}

	private static volatile PianiFabbisogniLocalService _service;
